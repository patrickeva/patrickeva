...
### Software Engineer · Full-Stack Web Developer · AI/ML Enthusiast
...
I'm a **Computer Science graduate** with a strong interest in software engineering, full-stack web development, and artificial intelligence.
...
Real-time monitoring platform for **driver franchises, licenses, and operational records** designed for LGU use.
...
Digital platform for managing and tracking **ordinances, resolutions, and legislative documents**.

**Tech:** `React` `Firebase` `Supabase` `JavaScript`
...
Freelance development portfolio showcasing **custom websites, web applications, and business systems**.
...
CNN-based system for identifying **nutrient deficiencies in bitter gourd leaves**, integrated with IoT hardware.

**Tech:** `Python` `TensorFlow` `CNN` `IoT`
...
Machine learning application for detecting **coffee leaf diseases** using a MobileNetV2 CNN architecture.
...
Django-based **student admission platform** designed with future machine learning integration for decision support.

**Tech:** `Django` `Python` `JavaScript` `TensorFlow`
...
A personal website showcasing my projects, technical experience, skills, and development journey.

[**Visit Portfolio →**](https://ptrkportfolio.vercel.app/)
...
I'm open to **collaboration, software engineering opportunities, freelance projects, and interesting technical conversations.**
